...
function Slider() {
  ...
  return (
    <>
      ...
      <button onClick={() => setdivPost(true)} className="AddSlide">
        Create new Image
      </button>
      {openDivPost && (
        <div className="Slider-opendiv">
          <label htmlFor="slider-input-image" className="Image-slider-label">
            {" "}
            Image
            <br />
            <input
              id="slider-input-image"
              type="file"
              className="Choose-slider-image"
              onChange={(e) => {
          ...
          <br />
          <button onClick={() => PostImage()} className="Submit-button">
            Submit
          </button>
          <br />
          <button
            onClick={() => setdivPost(!openDivPost)}
